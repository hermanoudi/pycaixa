import pytest
from mouracx.utils.email import check_valid_email
from mouracx.utils.user import generate_simple_password


# @pytest.mark.unit
# @pytest.mark.parametrize("address", ["hermanoudi@gmail.com", "joe@doe.com"])
...
# @pytest.mark.unit
# @pytest.mark.parametrize("address", ["hermano@.com", "@doe", "a@b"])
